    ...
    <div className="app-container">
      ...
      <header className="navbar">
        <div className="navbar-logo">
          ...
          <span>
            Scouter <span className="gradient-text">Ads</span>
          </span>
        </div>
        ...
        <AnimatePresence mode="wait">
          ...
          {step === "wizard" && (
            ...
            >
              ...
              <div className="wizard-form">
                ...
                <div className="form-group">
                  <label>Website URL (AI will analyze this)</label>
                  <input
                    type="url"
          ...
          {step === "generating" && (
            ...
            >
              ...
              <h2>Analyzing Website content...</h2>
              <p>
                Our AI is scanning the website and gathering strategic context.
              </p>
              ...
              <div className="status-timeline">
                ...
                >
                  <CheckCircle size={16} /> Fetching Website Content...
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, x: -10 }}
                  animate={{ opacity: 1, x: 0 }}
                  ...
                  className="status-item active"
                >
                  <CheckCircle size={16} /> Parsing Pages & Context...
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, x: -10 }}
                  animate={{ opacity: 1, x: 0 }}
                ...
                >
                  <Loader2 size={16} className="spin" /> Generating Best-Fit
                  Strategy...
                </motion.div>
              </div>
            </motion.section>
                ...
                >
                  ...
                  <div style={{ marginTop: "auto" }}>
                    <p className="text-muted" style={{ fontSize: "0.85rem" }}>
                      ...
                      />
                      Targeting: {formData.targetAudience || "AI Selected"}
                    </p>
                  </div>
                </motion.div>
